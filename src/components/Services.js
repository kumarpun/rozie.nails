const services = [
  {
    ...
    price: "$25",
    duration: "30 min",
    description: "Nail shaping, cuticle care, hand massage, and polish application for beautifully groomed nails.",
    icon: (
  ...
  },
  {
    ...
    price: "$35",
    duration: "45 min",
    description: "Long-lasting gel polish with a glossy finish that stays chip-free for up to two weeks.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    price: "$30",
    duration: "40 min",
    description: "Foot soak, exfoliation, nail care, and relaxing massage for refreshed and happy feet.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    price: "$40",
    duration: "50 min",
    description: "Full pedicure treatment finished with durable gel polish for long-lasting beautiful toes.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    price: "From $10",
    duration: "Varies",
    description: "Custom nail art designs from simple accents to intricate patterns. Express your style!",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    price: "$50",
    duration: "60 min",
    description: "Get the best of both worlds! Complete manicure and pedicure at a special combo price.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-foreground/60 mt-4 max-w-xl mx-auto">
            Quality nail care at affordable prices. Every service includes sanitized tools and a relaxing atmosphere.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            ...
            >
              <div className="text-pink-dark mb-4">{service.icon}</div>
        ...
        <p className="text-center text-sm text-foreground/50 mt-8">
          * Prices may vary based on nail condition and design complexity. Contact me for a custom quote.
        </p>
      </div>
    </section>
  );
